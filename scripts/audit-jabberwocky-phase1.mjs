...
for (const next of ['operation-03/', 'operation-04/', 'operation-05/', 'operation-06/', 'operation-07/', 'operation-08/']) {
  check(integration.includes(next), `navigation integration includes ${next}`);
}
...
check(pacing.includes('19 core classes + 6 flex classes'), 'five-week core pacing is present');
...
console.log('\nPhase 1 source routes, print controls, submission wiring, pacing inserts, data imports, teacher guides, and Teacher Launch Guide are internally consistent.');
