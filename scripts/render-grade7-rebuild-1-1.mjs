...
await browser.close();if(failed)process.exit(1);console.log('RENDER_SUMMARY desktop=pass tablet=pass 390=pass 375=pass 320=pass keyboard=pass reducedMotion=pass screenshots=5');
