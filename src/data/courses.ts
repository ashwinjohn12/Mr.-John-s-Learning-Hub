    ...
    units: [
      {
        ...
        topics: [
          ...
          { slug: 'more-patterns-in-division', number: '1.2', title: 'More Patterns in Division', summary: 'Extend divisibility reasoning to 3, 6, and 9 and explain why division by zero is undefined.', status: 'planned' },
          { slug: 'algebraic-expressions', number: '1.3', title: 'Algebraic Expressions', summary: 'Use variables to represent changing quantities and evaluate expressions.', status: 'planned' },
          { slug: 'relationships-in-patterns', number: '1.4', title: 'Relationships in Patterns', summary: 'Connect visual and contextual patterns to rules involving the term number.', status: 'planned' },
          { slug: 'patterns-tables', number: '1.5', title: 'Patterns and Relationships in Tables', summary: 'Create and analyze tables of values from input-output rules.', status: 'planned' },
          { slug: 'graphing-relations', number: '1.6', title: 'Graphing Relations', summary: 'Graph tables of values and use graphs to answer questions.', status: 'planned' },
          { slug: 'reading-writing-equations', number: '1.7', title: 'Reading and Writing Equations', summary: 'Translate statements into equations and distinguish equations from expressions.', status: 'planned' },
          { slug: 'equations-algebra-tiles', number: '1.8', title: 'Solving Equations Using Algebra Tiles', summary: 'Model and solve introductory whole-number equations while preserving equality.', status: 'planned' }
        ]
      },
